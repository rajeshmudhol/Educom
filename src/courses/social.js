...
function Social(){
    return(
        <div className="smbachg">
        <div className="ana">
        <div className="sub-social">
<h1>Advanced Social Media Program</h1>
...
<p>Simplilearn's Advanced Social Media Program for beginners provides an introduction to  social media </p><br></br>
<p>that helps you build the required skills to master social media marketing. This social media for</p><br></br>
<p>beginner course gives you comprehensive knowledge on content marketing.reputation management. </p><br></br>
<h4>17306 Ratings </h4>

<h5>52707 Learns</h5>
</div>
<div className="social-skill">
    ...
    <p>Web analytics</p>
    <p>Youtube and videos marketing </p>
...
<p>Pinterest</p>
        ...
        <div className="social-lear">
            <h2>Who should learn</h2>
            <p id="smm">Marketing Managers</p>
            <p id="dme">Digital Marketing Executives</p>
            <p id="scw">content Writers</p>
            <p id="smg">Management Graduates</p>
            <p id="seo">Entrepreneurs</p>
