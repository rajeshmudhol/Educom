...
import "./artifci.css"
 function Artifici(){
    return(
        <div className="abachg">
        <div className="ana">
        <div className="sub-arti">
...
<p>This artificial Intelligence basics Program is designed to offer an overview of AI concepts & workflows. </p><br></br>
<p>along with the fundamentals of machine learning and deep learning learn AI along by working on specific</p><br></br>
<p>use cases&learn the difference between on specific use cases & learn AI alon by working on specific.</p><br></br>
<h4>7009 rating</h4>

<h5>52707 Learns</h5>
</div>
<div className="arti-skill">
    <h2>Skills you will gain</h2>
    <p>Purpose of artificial Intelligence technology</p>
    <p>concepts of deep learning and machine learning workflow</p>
    ...
    <p>Unsupervised learning</p>
        ...
        <div className="arti-lear">
            <h2>Who should learn</h2>
            <p id="adev">Developers</p>
            <p id="aam">Analytics Managers</p>
            <p id="ain">information Architects</p>
            <p id="aanp">Analytics Professionals</p>
            
        </div>
        {/* <div className="aprojct">
          <h2>Industry Project</h2>
          <div className="container12">
            <div className="arti-projc">
              <h5>Project 1</h5>
        ...
        {/* </div> */}
        <div className="areviws">
          <h2>AI Master program Reviews</h2>
          <div className="container12">

            <div className="arti-revu">
