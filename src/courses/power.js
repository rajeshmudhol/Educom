...
function Power(){
    return(
        <div className="pbachg">
        <div className="ana">
        <div className="sub-pow">
<h1>Power BI for Beginnners</h1>
...
<p>Power BI Nasics free course takes you through desktop layouts,BI reports,dashboards,Power</p><br></br>
<p>BI DAX commands.and functions.Power BI is a business analytics tool that helps analysts use </p><br></br>
<p>interactive visualizations to create dashboards and reports.this free course will help you  </p><br></br>
<h4>17306 Ratings </h4>

<h5>52707 Learns</h5>
</div>
<div className="pow-skill">
    <h2>Skills you will gain</h2>
    <p>Power BI components</p>
    <p>Power BI services</p>
    <p>DAX functions</p>
    <p>Data modeling</p>
    <p>Power BI Dashboard</p>
        ...
        <div className="pow-lear">
            <h2>Who should learn</h2>
            <p id="bir">BI and Reporting professionals</p>
            <p id="dana">Data analysts</p>
            <p id="datp">Data professionsals</p>
