...
function Sqlto(){
    return(
        <div className="sbachg">
        <div className="ana">
        <div className="sub-sqll">
...
<p>Learn SQL and develop a functional knowledge of the leading programing language for relational database managment </p><br></br>
<p>systems. The introduction to SQL course will cover important topics like MySQL,PostgreSQL and SQL Server,</p><br></br>
{/* <p>built-in SQL functions,joins and subquries stored procedures</p><br></br> */}
<h4>17306 Ratings </h4>

<h5>52707 Learns</h5>
</div>
<div className="sqll-skill">
    ...
    <p>SQL Server</p>
        ...
        <div className="sqll-lear">
            <h2>Who should learn</h2>
            <p id="ssp">Software professionals</p>
            <p id="spp">Programmers</p>
            <p id="stp">Testing Professionals</p>
        ...
        <div className="sreviws">
          <h2>What other Learners are saying</h2>
          <div className="container9">

            <div className="sqll-revu">
