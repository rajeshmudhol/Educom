...
import "./excel.css"
  function Analy(){
    return(
      <div className="bachg">
        <div className="ana">
        <div className="sub-bussi">
<h1>Business Analytics With Excel</h1>
...
<p>Take this introduction to Business Analytics With Excel for beginners free course to booost your </p><br></br>
<p>Microsoft Excel Skills. including the introduction to Power Bi course.this program will drive you to</p><br></br>
<p>the path of succes with business analytics basics. Learn business analytics fundamentals like data </p><br></br>
<h4>17306 Ratings </h4>
...
<div className="sub-skill">
    ...
    <p>Excel analytics functions</p>
    <p>Excel conditional formatting</p>
    <p>Pivot tables and slicers</p>
    <p>scenario manager tool</p>
    <p>Solver tool</p>
    <p>Goal seek tool</p>
    <p>ANOVA</p>
...
<p>Power Bi</p>
        ...
        <div className="sub-lear">
            <h2>Who should learn</h2>
            <p id="devp">IT Developer and Testers</p>
            <p id="data">Data Analysts</p>
            <p id="juni">Junior Data Scientists</p>
            <p id="anal">Analytics Professionals</p>
            <p id="bi">BI and Reporting Professionals</p>
            <p id="proc">Project Managers</p>
