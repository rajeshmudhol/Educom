    ...
    <p>User authorization and authentication</p>
        ...
        <div className="projc">
          ...
          <div className="container6">
            <div className="msex-projc">
              <h5>Project 1</h5>
              <h3>Manage the Password</h3>
              <p>Develop a new version of a Password manager  </p>
              <p>can keep track of all the Password that have </p>
              <p>sent for respective accounts</p>
            </div>
            <div className="msex-projc">
              <h5>Project 2</h5>
              <h3>Python Decorators</h3>
              <p>Implement a python decorator that should </p>
              <p>whaytever the decorated function returns,and  </p>
              <p>it to a file in a new line </p>
              
            </div>
            <div className="msex-projc">
              <h5>Project 3</h5>
              <h3>Patient Management Application</h3>
              <p>Write an application in Django for a hospital</p>
              <p>receptionist that has features,including  </p>
              <p>Checking the patient is already registered. </p>
              <p>if not register the patient</p>
            </div>
          </div>
